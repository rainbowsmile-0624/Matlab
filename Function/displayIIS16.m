function [my_data1,my_data2]=displayIIS16(my_table)
...
my_string=strrep(my_string,'Left channel: 0000','');
my_string=strrep(my_string,'Right channel: 0000','');
...
for i=1:length(my_string)/2
    my_data1(i)=convertToOriCode(hex2dec(my_string(i*2-1)),16);
    my_data2(i)=convertToOriCode(hex2dec(my_string(i*2)),16);
end
